...
2017년에 작성한 글은 새 글 목록과 분리해 보관합니다. 기존 게시물의 permalink는 유지하고, 이 페이지에서만 다시 찾아볼 수 있도록 운영합니다.
...
{% endfor %}
{% else %}
아직 이 저장소에 보존된 2017년 게시물 원본이 없습니다. 원본을 추가하면 `legacy: true`와 기존 permalink를 유지한 채 이 목록에 표시됩니다.
{% endif %}
